...
internal data class CatalogInstalledState(val version: String, val digest: String, val confirmed: Boolean)
...
internal object CatalogInstallPresentation {
    ...
    fun choice(
        ...
        if (current != null && !current.confirmed) return CatalogInstallChoice("Test current version first", false,

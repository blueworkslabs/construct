...
def main():
    ...
    p.add_argument('--emulate-front-camera',action='store_true',help='Provide a generated front camera as well; never a physical webcam')

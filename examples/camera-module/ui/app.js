...
cameraButton.onclick=async()=>{
  ...
  catch(error){cameraStatus.className='error';cameraStatus.textContent='['+(error.code||'UNAVAILABLE')+'] '+(cameraErrors[error.code]||'Could not open the camera. Close and reopen to retry.');}
